...
namespace CursoWebMVC.Data
{
    ...
    {
        private CursoWebMVCContext _context;
        ...
        public void Seed ()
        {
            ...
            Saller s1 = new Saller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.00, d1);
            Saller s2 = new Saller(2, "Julia Ramos", "ju@gmail.com", new DateTime(2002, 3, 25), 10750.00, d4);
            Saller s3 = new Saller(3, "Fabricio Alves", "fabrani@gmail.com", new DateTime(2000, 10, 11), 2200.00, d1);
            Saller s4 = new Saller(4, "Renan Geronazzo", "re@gmail.com", new DateTime(2000, 9, 15), 1200.00, d3);
            Saller s5 = new Saller(5, "Diego Tadeu", "tadeu@gmail.com", new DateTime(1999, 8, 13), 1000.00, d2);
            Saller s6 = new Saller(6, "Matheus Armelin", "armelindo@gmail.com", new DateTime(2001, 4, 29), 500.00, d1);
